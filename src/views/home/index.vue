<template>
  <div id="home">
    <!--<span class="current-title">宜家中国</span>-->
    <div id="cityMap"></div>
    <div class="map-describe">
      <div class="title">地图描述</div>
      <ul class="content">
        <li class="item">当前局点指标正常</li>
        <li class="item">当前局点指标异常</li>
      </ul>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    mapBox () {
      ...
      //        ]
      //      })
      //      cityMap.showLoading(showLoadingDefault)
      //      this.$store.commit('openLoading')
      //      this.$store.dispatch('fetchHeatChinaRealData', cityMap)
      //      setInterval(() => {
      //        this.$store.dispatch('fetchHeatChinaRealData', cityMap)
      //      }, 1000)
      ...
      //        {name: '合肥', value: 229},
      //        {name: '武汉', value: 273},
      //        {name: '大庆', value: 279, url: '/wasteWater'}
      //      ]
      //      const geoCoordMap = {
      //        '海门': [121.15, 31.89],
      //        '鄂尔多斯': [109.781327, 39.608266],
      ...
      //              name: data[i].name,
      //              value: geoCoord.concat(data[i].value),
      //              url: geoCoord.concat(data[i].url)
      //            })
      //          }
      //        }
      //        return res
      ...
      cityMap.on('click', function (params) {
        ...
        self.$router.push(
          {
            name: 'ApplyCenter',
            params: { countryid: city }
          }
        )
        // alert(city)
        // const url = params.data.url[2]
        // console.log(url)
